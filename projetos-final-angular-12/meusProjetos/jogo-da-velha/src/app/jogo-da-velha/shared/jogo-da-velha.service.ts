...
export class JogoDaVelhaService {
  ...
  //Inicializa o jogo. Define exibição tela inicial
  inicializar(): void {
  ...
  //Inicializa o tabuleiro do jogo com vazio para tds posições
  ...
  //Retorna o nmr do jogador a jogar
  get jogador(): number {
  ...
  //Obtem uma jogada válida para vitoria de um jogador
